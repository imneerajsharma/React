...
export default function About(props) {
    ...
    // })
    let myStyle ={
        color: props.mode==='dark'?'white':'#858181',
        backgroundColor: props.mode==='dark'?'#858181':'white',
        border: '2px solid',
        borderColor: props.mode==='dark'?'white':'#858181'
    }
    ...
    // }
  return (
    <div className="container" style={{color: props.mode==='dark'?'white':'#858181'}}>
