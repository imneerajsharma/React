    ...
    <div className ="h-[90vh]">
        ...
        <div className="bannerMiniContainer px-36">
            <p className="text text-5xl font-bold text-white w-[25rem] mb-5 ">
                Moving the people, and the world
            </p>
            ...
            <div className='bg-white pt-5'>
                <div className='flex items-center justify-around'>
                    ...
                    <div className='flex items-center py-2 px-14 border border-slate-900'>
                        <CircleIcon className="pr-8 text-red-700" style={{fontSize:40}} /> <p>Current Location</p>
                    </div>
                    <div onClick={()=>router.push("/")} className="searchOlaCAbButton cursor-pointer flex item-center py-4 px-14 border border-slate-900 justify-around">
