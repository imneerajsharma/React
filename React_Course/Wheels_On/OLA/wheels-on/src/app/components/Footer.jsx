    ...
    <footer className='mt-40'>
      <div className='container py-8'>
        <div className='grid grid-cols-1 md:flex justify-around'>
          <div className="footer-links">
            ...
            />
              <div className='flex items-center mt-5'>
                ...
                <YouTubeIcon className="" style={{fontSize:40}}/>
                <TwitterIcon className="" style={{fontSize:40}}/>
          ...
          <div className='footer-links'>
            <h3 className="text-lg font-semibold">Cutomer Support</h3>
            <ul className='mt-4'>
              <li>
      ...
      <div className='bg-gray-800 py-4'>
        <div className='container mx-auto'>
          <p className='text-center text-gray-400 text-sm'>
            &copy;{new Date().getFullYear()}Ola Cabs. All rights reserved.</p> 
